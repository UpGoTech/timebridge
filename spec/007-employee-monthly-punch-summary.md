...
- One row per **calendar day** in the month (blank in/out/hrs on absent days — punches are never invented)
- Punches for the selected user's `user_id` on **all machines** merged per day (optional Machine filter narrows this)
...
2. All calendar days shown; days with punches show in/out/hrs/count from Punch Log (nothing invented)
...
| Q4 | All calendar days in month, blanks for absent days (punches never invented) |
